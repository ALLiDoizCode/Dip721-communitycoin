...
const Description = () => {
    ...
    <Container className="darken">
        ...
        <p>Every transaction done with CIG will cost 11% to it's holder.
             These tokens will then be distributed five ways. Three percent will be burnt, three percent will be sent to every holder of the token to encourage holding, Two percent will be going to a developer treasury for marketing and future development, and 3 percent will go to a VC treasury which will be used for angel investment. </p>
    </Container>
    </>
