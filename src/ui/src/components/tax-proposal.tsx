    ...
    <>
      <Form className="proposal-form" onSubmit={onFormSubmit}>
        <Form.Group className="mb-3" controlId="formBasicTitle">
          ...
          />
          <Form.Text className="text-muted">This is the title for your proposal</Form.Text>
        </Form.Group>
        <Form.Group className="mb-3" controlId="formTaxType">
          ...
          <Form.Text className="text-muted">What about tokenomics would you like to change?</Form.Text>
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicTitle">
          ...
          <Form.Control
            ...
            onChange={(e) => setValue("taxValue", e?.target?.value)}
          />
          <Form.Text className="text-muted">Change to what percent?</Form.Text>
        </Form.Group>
        ...
        {(param.proposalCost.compareTo(ycBalance) === 1 || !connected) && (
          <>
            <span className="text-danger">You don't have enough YC to make a proposal or you are not connected</span>
            <br />
          </>
        )}
